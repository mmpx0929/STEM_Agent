        ...
        <template v-if="section.key === 'step1'">
          ...
          <view class="step1-layout">
            <view class="section-image image-panel">
              <image
                v-if="showMaterialImage && resolvedMaterialImageUrl"
                class="material-image"
                :src="resolvedMaterialImageUrl"
                mode="aspectFit"
...
const DEFAULT_MATERIAL_IMAGE_URL = '/static/experiments/science-01/images/virtual-lab/0全部材料.mobile.jpg';
...
export default {
  ...
  computed: {
    ...
    resolvedMaterialImageUrl() {
      return encodeStaticAssetPath(this.materialImageUrl || DEFAULT_MATERIAL_IMAGE_URL);
    },
    selectedSections() {
