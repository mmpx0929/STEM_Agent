...
const STEP_AI_GUIDE_AUDIO_MAP = {
  step1: '/static/audio/science_step1.mp3',
  step2: '/static/audio/science_step2.mp3',
  step3: '/static/audio/science_step3.mp3',
  step4: '/static/audio/science_step4.mp3',
  step5: '/static/audio/science_step5.mp3',
  step6: '/static/audio/science_step6.mp3',
  step7: '/static/audio/science_step7.mp3',
  step8: '/static/audio/science_step8.mp3',
  step9: '/static/audio/science_step9.mp3',
  step10: '/static/audio/science_step10.mp3'
};
...
export default {
  ...
  computed: {
    ...
    aiGuideAudio() {
      const key = this.currentStep && this.currentStep.key ? this.currentStep.key : 'step1';
      return STEP_AI_GUIDE_AUDIO_MAP[key] || '';
    },
    isCurrentStepReady() {
...
/* Mobile hit/fit fixes for the expanded scheme-design stage. */
.page .step-tabs,
.page .step-tabs.collapse-mode,
.page .step-tabs.collapse-mode .collapse-inner,
.page .stage-main-row,
...
/* The expanded plan steps must be part of the scroll content, not an absolute popover. */
