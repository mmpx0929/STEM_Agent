  ...
  <view class="page">
    ...
    <scroll-view class="step-tabs collapse-mode" scroll-x>
      <view class="step-tabs-inner collapse-inner" :class="{ expanded: planStageExpanded }">
        ...
        <view
          v-if="planStageExpanded"
          class="stage-expand-row"
          :class="{ 'stage-active': isPlanStageActive, 'stage-done': isPlanStageDone }"
        >
          <view class="step-group-container">
            <view class="group-background">
              <view class="group-steps">
                <view
                  v-for="(step, index) in stepDefs.slice(1, 5)"
                  :key="`expanded-${step.key}`"
                  class="step-item group-step"
                  :class="getStepChipClass(index + 1)"
                  @click="jumpStep(index + 1)"
                >
...
const STEP_AI_GUIDE_AUDIO_MAP = {
  step1: '/static/audio/engineering_step1.mp3',
  step2: '/static/audio/engineering_step2.mp3',
  step3: '/static/audio/engineering_step3.mp3',
  step4: '/static/audio/engineering_step4.mp3',
  step5: '/static/audio/engineering_step5.mp3',
  step6: '/static/audio/engineering_step6.mp3',
  step7: '/static/audio/engineering_step7.mp3',
  step8: '/static/audio/engineering_step8.mp3',
  step9: '/static/audio/engineering_step9.mp3'
};
  ...
  computed: {
    ...
    aiGuideAudio() {
      ...
      const audioMap =
        ...
        || STEP_AI_GUIDE_AUDIO_MAP;
      return audioMap[key] || STEP_AI_GUIDE_AUDIO_MAP[key] || '';
    },
    isCurrentStepReady() {
...
/* Mobile hit/fit fixes for the expanded engineering-scheme stage. */
.page .step-tabs,
.page .step-tabs.collapse-mode,
.page .step-tabs.collapse-mode .collapse-inner,
.page .stage-main-row,
...
/* The expanded engineering steps must be part of the scroll content, not an absolute popover. */
.page .stage-plan-anchor > .stage-expand-pop {
  display: none;
}
...
.page .stage-expand-row .step-group-container {
  margin-right: 0;
  display: inline-flex;
  overflow: visible;
}

.page .stage-expand-row .group-background {
  min-height: 178rpx;
...
.page .stage-expand-row .group-steps {
  display: inline-flex;
  align-items: flex-start;
  justify-content: center;
  flex-wrap: nowrap;
...
.page .stage-expand-row .group-step {
  width: 148rpx;
  min-height: 138rpx;
  margin-right: 10rpx;
  justify-content: flex-start;
...
.page .stage-expand-row .group-step:last-child {
  margin-right: 0;
}

.page .stage-expand-row .group-step .step-chip {
  width: 60rpx;
  min-width: 60rpx;
  height: 60rpx;
}

.page .stage-expand-row .group-step .step-label {
  width: 100%;
  min-height: 58rpx;
  max-height: none;
  height: auto;
