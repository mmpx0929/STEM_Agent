...
const eng6Image = (name) => '/static/experiments/engineering-06/images/' + toMobileImagePath(name);
...
const flowTemplate = withOverride(BASE_TEMPLATE, {
    ...
    step4: {
	  ...
	  blueprints: [
	    { name: '模型图纸设计 1', path: eng6Image('4-1.png') },
	    { name: '模型图纸设计 2', path: eng6Image('4-2.png') }
	  ],
	  buildStepOptions: [
	    {
	      key: 'step1',
	    ...
	    {
	      key: 'step2',
	      title: '模型搭建步骤：制作迭代电动动力系统',
	      summary: '制作迭代电动动力系统。',
	      lines: [
	        '使用材料：上一节课的电动洗衣机、电池盒、电池；工具：剪刀（自备）。',
	      ]
	    },
		{
		  key: 'step3',
		  ...
		  summary: '组装电动洗衣机。',
		  lines: [
		    '使用材料：上一节课的电动洗衣机、迭代电动动力系统；工具：剪刀（自备）。',
		  ]
		},
	    {
	      key: 'step4',
	      title: '模型测试：完成电机正反转测试',
	      summary: '电机正反转测试。',
	      lines: ['检查开关切换顺序和线路连接是否稳定。']
	    }
	  ],
      buildSteps: [
        '步骤1：准备搭建材料和工具。',
    ...
    step7: {
	  ...
	  testGuideVideo: {
	    ...
	    videos: [
	      { title: '测试流程 1', videoUrl: '/static/experiments/engineering-06/videos/8-1.mobile.mp4' },
	      { title: '测试流程 2', videoUrl: '/static/experiments/engineering-06/videos/8-2.mobile.mp4' }
	    ]
	  },
      records: [
        {
        ...
        },
        {
		  ...
		  effect: '',
		  effectByChoice: {
		    A: '达标：性能正常，运转高效，能把袜子洗得更干净。',
		    B: '部分达标：运转偶尔会出现卡顿，需要继续优化。'
		  }
        },
        {
          key: 'operation',
...
const config = {
  ...
  intro: {
    ...
    step1VideoUrl: '/static/experiments/engineering-06/videos/intro.mobile.mp4'
  },
  voiceGuide: {
    stepGuideTextMap: ENGINEERING_STEP_GUIDE_TEXT_MAP,
    stepSceneMap: ENGINEERING_STEP_SCENE_MAP
