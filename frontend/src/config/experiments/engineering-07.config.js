...
const experimentId = 'engineering-07';
const flowTemplate = withOverride(BASE_TEMPLATE, {
  id: 'engineering-07',
  step1: {
    coreQuestion: '如何设计并验证方形滚筒甩干机，让它在非常规结构下也能稳定旋转并实现有效甩干？',
    introHintText: '先看生活场景视频，再想一想：如何设计并验证方形滚筒甩干机，让它在非常规结构下也能稳定旋转并实现有效甩干？'
  }
});
...
const config = {
  ...
  legacyId: null,
  title: '方形滚筒甩干机的创意设计与工程实践测试',
  summary: '探索非常规结构在工程场景中的表现。',
  status: 'coming-soon',
  intro: {
    homeVideoUrl: '/static/Introductory-video/home.mobile.mp4',
    step1VideoUrl: '/static/experiments/engineering-07/videos/intro.mobile.mp4'
  },
  voiceGuide: {
    stepGuideTextMap: ENGINEERING_STEP_GUIDE_TEXT_MAP,
    stepSceneMap: ENGINEERING_STEP_SCENE_MAP
