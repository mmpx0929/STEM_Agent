...
const eng4Image = (name) => '/static/experiments/engineering-04/images/' + toMobileImagePath(name);
...
const flowTemplate = withOverride(BASE_TEMPLATE, {
    ...
    step7: {
	  ...
	  testGuideVideo: {
	    ...
	    videoUrl: '/static/experiments/engineering-04/videos/8-1.mobile.mp4'
	  },
      records: [
        {
          key: 'dewater',
...
const config = {
  ...
  intro: {
    ...
    step1VideoUrl: '/static/experiments/engineering-04/videos/intro.mobile.mp4'
  },
  voiceGuide: {
    stepGuideTextMap: ENGINEERING_STEP_GUIDE_TEXT_MAP,
    stepSceneMap: ENGINEERING_STEP_SCENE_MAP
