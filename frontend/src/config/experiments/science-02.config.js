...
const flowTemplate = {
      ...
      logicOptions: [
        {
          ...
          videoUrl: '/static/experiments/science-02/videos/5-1.mobile.mp4',
          videoPoster: ''
        }
      ],
      baseMaterials: [
    ...
    step7: {
      materialImageUrl: '/static/experiments/science-02/images/材料与步骤图/全部材料.mobile.jpg',
      majorSteps: [
        {
          key: 'step1',
          title: '准备实验材料、实验工具',
...
const config = {
  ...
  intro: {
    ...
    step1VideoUrl: '/static/experiments/science-02/videos/intro.mobile.mp4'
  },
  voiceGuide: {
    stepGuideTextMap: SCIENCE_STEP_GUIDE_TEXT_MAP,
    stepSceneMap: SCIENCE_STEP_SCENE_MAP
