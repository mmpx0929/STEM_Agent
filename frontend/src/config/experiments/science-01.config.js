...
const flowTemplate = {
      ...
      logicOptions: [
        {
          ...
          videoUrl: '/static/experiments/science-01/videos/5-1.mobile.mp4',
          videoPoster: ''
        },
        {
          key: 'logic2',
          ...
          videoUrl: '/static/experiments/science-01/videos/5-2.mobile.mp4',
          videoPoster: ''
        }
      ],
    ...
    step7: {
      materialImageUrl: '/static/experiments/science-01/images/材料与步骤图/0全部材料.mobile.jpg',
      majorSteps: [
        {
          key: 'step1',
          title: '准备实验材料、实验工具',
...
const config = {
  ...
  intro: {
    ...
    step1VideoUrl: '/static/experiments/science-01/videos/intro.mobile.mp4'
  },
  voiceGuide: {
    stepGuideTextMap: SCIENCE_STEP_GUIDE_TEXT_MAP,
    stepSceneMap: SCIENCE_STEP_SCENE_MAP
