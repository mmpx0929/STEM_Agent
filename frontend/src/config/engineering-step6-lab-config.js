import { toMobileImagePath } from './media-utils.js';

const eng1Img = (name) => `/static/experiments/engineering-01/images/virtual-build/${toMobileImagePath(name)}`;
const eng1Extra = (name) => `/static/experiments/engineering-01/images/材料与步骤图/1脱水桶打孔/${toMobileImagePath(name)}`;
const eng1Video = (name) => `/static/experiments/engineering-01/videos/${name}`;
const eng2Overview = (name) => `/static/experiments/engineering-02/images/overview/${toMobileImagePath(name)}`;
const eng2Step = (folder, name) => `/static/experiments/engineering-02/images/材料与步骤图/${folder}/${toMobileImagePath(name)}`;
const eng2Video = (name) => `/static/experiments/engineering-02/videos/${name}`;
const eng3Build = (name) => `/static/experiments/engineering-03/images/build-steps/${toMobileImagePath(name)}`;
const eng3Overview = (name) => `/static/experiments/engineering-03/images/overview/${toMobileImagePath(name)}`;
const eng3Material = (folder, name) => `/static/experiments/engineering-03/images/材料图/${folder}/${toMobileImagePath(name)}`;
const eng3Video = (name) => `/static/experiments/engineering-03/videos/${name}`;
const eng4Overview = (name) => `/static/experiments/engineering-04/images/overview/${toMobileImagePath(name)}`;
const eng4Material = (folder, name) => `/static/experiments/engineering-04/images/材料图/${folder}/${toMobileImagePath(name)}`;
const eng4Video = (name) => `/static/experiments/engineering-04/videos/${name}`;
const eng5Material = (folder, name) => `/static/experiments/engineering-05/images/材料图/${folder}/${toMobileImagePath(name)}`;
const eng5Video = (name) => `/static/experiments/engineering-05/videos/${name}`;
const eng6Material = (folder, name) => `/static/experiments/engineering-06/images/材料图/${folder}/${toMobileImagePath(name)}`;
const eng6Video = (name) => `/static/experiments/engineering-06/videos/${name}`;
const sci1Img = (name) => `/static/experiments/science-01/images/virtual-lab/${toMobileImagePath(name)}`;
  ...
  supportVideos: [
    {
      ...
      videoUrl: eng1Video('6-1.mobile.mp4')
    },
    {
      id: 'eng1-practice-demo',
      title: '实践动手讲解',
      desc: '小朋友尝试着线下搭建自己的模型吧，遇到问题记得跟着视频一步一步操作哦。',
      videoUrl: eng1Video('6-2.mobile.mp4')
    }
  ]
});
  ...
  supportVideos: [
    {
      ...
      videoUrl: eng2Video('6-1.mobile.mp4')
    },
    {
      id: 'eng2-practice-demo',
      title: '实践动手讲解',
      desc: '小朋友尝试着线下搭建自己的模型吧，遇到问题记得跟着视频一步一步操作哦。',
      videoUrl: eng2Video('6-2.mobile.mp4')
    }
  ]
});
...
const ENGINEERING_03_STEP6_CONFIG = createConfig({
  materialToolItems: [
    ...
    { id: 'bucket_foam', label: '泡棉胶', type: 'material', image: eng3Material('1制作脱水桶系统', '泡棉胶1.jpg') },
    { id: 'bucket_pulley', label: '皮带轮', type: 'material', image: eng3Material('1制作脱水桶系统', '皮带轮1.jpg') },
  ...
  recipes: [
    {
      ...
      hint: '环节1：制作脱水桶系统。使用材料：圆筒网兜、皮带轮、泡棉胶。',
      nextHint: '下一步进入环节2：制作电动动力系统。'
    },
    {
      id: 'recipe_electric_power_system',
      output: 'electric_power_system',
      inputs: ['motor', 'battery_box', 'battery_pack', 'straw', 'assembly_scissors'],
    ...
    },
    {
      ...
      output: ENGINEERING_STEP6_FINAL_RESULT_ID,
      inputs: ['bucket_system', 'electric_power_system', 'shell_system', 'bucket_pulley', 'bucket_foam', 'clear_tape', 'assembly_scissors'],
      hint: '环节4：组装电动甩干机。使用系统：脱水桶系统、电动动力系统、外壳系统；使用材料：皮带轮、泡棉胶、透明胶；使用工具：剪刀（自备）。',
      nextHint: '已完成全部关键环节。'
    }
  ],
  supportVideos: [
    {
      ...
      videoUrl: eng3Video('7-1.mobile.mp4')
    }
  ]
});
  ...
  supportVideos: [
    {
      ...
      videoUrl: eng4Video('7-1.mobile.mp4')
    }
  ]
});
...
const ENGINEERING_05_STEP6_CONFIG = createConfig({
  materialToolItems: [
    { id: 'motor', label: '电机', type: 'material', image: eng5Material('1制作电动动力系统', '电机.jpg') },
    { id: 'battery', label: '电池', type: 'material', image: eng5Material('1制作电动动力系统', '3节电池.jpg') },
    { id: 'straw', label: '吸管', type: 'material', image: eng5Material('1制作电动动力系统', '吸管.jpg') },
    { id: 'battery_box', label: '电池盒', type: 'material', image: eng5Material('1制作电动动力系统', '电池盒.jpg') },
    { id: 'shell_system', label: '外壳系统', type: 'material', image: eng5Material('2组装电动洗衣机', '外壳系统.jpg') },
    { id: 'foam_tape_2', label: '泡棉胶', type: 'material', image: eng5Material('2组装电动洗衣机', '泡棉胶2.jpg') },
    { id: 'pulley', label: '皮带轮', type: 'material', image: eng5Material('2组装电动洗衣机', '皮带轮2.jpg') },
    { id: 'impeller', label: '波轮', type: 'material', image: eng5Material('2组装电动洗衣机', '波轮.jpg') },
    { id: 'turbine', label: '涡轮', type: 'material', image: eng5Material('2组装电动洗衣机', '涡轮.jpg') },
    { id: 'clear_tape', label: '透明胶', type: 'material', image: eng5Material('2组装电动洗衣机', '透明胶.jpg') },
    { id: 'scissors', label: '剪刀（自备）', type: 'tool', image: eng5Material('1制作电动动力系统', '自备剪刀.jpg') }
  ],
  resultItems: [
    { id: 'electric_power_system', label: '电动动力系统', image: eng5Material('1制作电动动力系统', '电动动力系统.jpg') },
    { id: ENGINEERING_STEP6_FINAL_RESULT_ID, label: '电动洗衣机', image: eng5Material('2组装电动洗衣机', '涡轮成品.jpg') }
  ],
  recipes: [
    {
      id: 'recipe_electric_power_system',
      ...
      nextHint: '下一步进入环节2：组装电动洗衣机。'
    },
    {
      id: 'recipe_electric_washer_final',
      output: ENGINEERING_STEP6_FINAL_RESULT_ID,
      inputs: ['electric_power_system', 'shell_system', 'pulley', 'foam_tape_2', 'clear_tape', 'impeller', 'turbine'],
      hint: '环节2：组装电动洗衣机。使用系统：电动动力系统、外壳系统；使用材料：皮带轮、泡棉胶、透明胶、波轮、涡轮。',
      nextHint: '已完成全部关键环节。'
    }
  ],
  supportVideos: [
    {
      id: 'eng5-practice-demo',
      title: '实践动手讲解',
      desc: '小朋友尝试着线下搭建自己的模型吧，遇到问题记得跟着视频一步一步操作哦。',
      videoUrl: eng5Video('7-1.mobile.mp4')
    }
  ]
});
...
const ENGINEERING_06_STEP6_CONFIG = createConfig({
  materialToolItems: [
    { id: 'previous_washer', label: '上一节课的电动洗衣机成品', type: 'material', image: eng6Material('制作迭代电动动力系统', '上一节课的电动洗衣机成品.jpg') },
    { id: 'battery_box', label: '电池盒', type: 'material', image: eng6Material('制作迭代电动动力系统', '电池盒.jpg') },
    { id: 'battery', label: '3节电池', type: 'material', image: eng6Material('制作迭代电动动力系统', '3节电池.jpg') }
  ],
  resultItems: [
    { id: ENGINEERING_STEP6_FINAL_RESULT_ID, label: '正反转电动洗衣机', image: eng6Material('制作迭代电动动力系统', '成品.jpg') }
  ],
  recipes: [
    {
      id: 'recipe_reversing_washer_final',
      output: ENGINEERING_STEP6_FINAL_RESULT_ID,
      inputs: ['previous_washer', 'battery_box', 'battery'],
      hint: '环节1：制作迭代电动动力系统并完成正反转电动洗衣机。使用材料：上一节课的电动洗衣机成品、电池盒、3节电池。',
      nextHint: '已完成全部关键环节。'
    }
  ],
  supportVideos: [
    {
      id: 'eng6-practice-demo',
      title: '实践动手讲解',
      desc: '小朋友尝试着线下搭建自己的模型吧，遇到问题记得跟着视频一步一步操作哦。',
      videoUrl: eng6Video('7-1.mobile.mp4')
    }
  ]
});
