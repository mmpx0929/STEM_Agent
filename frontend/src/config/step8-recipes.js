...
const science1Material = (group, name) => `/static/experiments/science-01/images/材料与步骤图/${group}/${toMobileImagePath(name)}`;
const science2Material = (group, name) => `/static/experiments/science-02/images/材料与步骤图/${group}/${toMobileImagePath(name)}`;
const science2ShowcaseVideo = (name) => `/static/experiments/science-02/videos/制作视频+展示视频/${name}`;
const science2Making = (name) => `/static/experiments/science-02/videos/制作视频+展示视频/完整制作/${toMobileImagePath(name)}`;
...
const SCIENCE_01_STEP8_CONFIG = createConfig({
  ...
  operationOptions: [
    {
      ...
      videoUrl: '/static/experiments/science-01/videos/op2-slow-speed.mobile.mp4',
      poster: ''
    },
    {
      id: 'op2',
      ...
      videoUrl: '/static/experiments/science-01/videos/op1-high-speed.mobile.mp4',
      poster: ''
    }
  ],
  recipes: [
  ...
  practiceVideo: {
    ...
    videoUrl: '/static/experiments/science-01/videos/8-1-compressed.mobile.mp4',
    poster: '/static/experiments/science-01/videos/8-1.mobile.jpg'
  }
});
...
const SCIENCE_02_STEP8_CONFIG = createConfig({
  ...
  operationOptions: [
    {
      ...
      videoUrl: science2ShowcaseVideo('慢速旋转.mobile.mp4'),
    ...
    },
    {
      ...
      videoUrl: science2ShowcaseVideo('快速旋转.mobile.mp4'),
      poster: science2Making('完整制作-封面.jpg')
    }
  ],
  recipes: [
  ...
  practiceVideo: {
    ...
    videoUrl: science2Making('完整制作.mobile.mp4'),
    poster: science2Making('完整制作-封面.jpg')
  }
});
