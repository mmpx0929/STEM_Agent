...
export const BADGES = [
  {
    ...
    icon: '/static/project-common/images/badges/explorer.mobile.jpg', 
  ...
  },
  {
    ...
    icon: '/static/project-common/images/badges/science.mobile.jpg',
    condition: (allProgress) => {
  ...
  },
  {
    ...
    icon: '/static/project-common/images/badges/engineering.mobile.jpg',
    condition: (allProgress) => {
      const allIds = [1, 2, 3, 4, 5, 6, 7, 8, 9];
  ...
  },
  {
    ...
    icon: '/static/project-common/images/badges/time.mobile.jpg',
    condition: (allProgress) => {
      const dates = new Set();
  ...
  },
  {
    ...
    name: '终极大师',
    description: '完成所有实验',
    icon: '/static/project-common/images/badges/master.mobile.jpg',
    condition: (allProgress) => {
      const allIds = [1, 2, 3, 4, 5, 6, 7, 8, 9];
