...
rem Frontend origins allowed by FastAPI CORS.
if "%STEM_CORS_ORIGINS%"=="" (
  set STEM_CORS_ORIGINS=http://127.0.0.1:5173,http://localhost:5173,http://127.0.0.1:8080,http://localhost:8080,http://127.0.0.1:3000,http://localhost:3000
)
